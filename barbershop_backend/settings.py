"""
Django settings for barbershop_backend project.
...
ROOT_URLCONF = 'barbershop_backend.urls'
...
WSGI_APPLICATION = 'barbershop_backend.wsgi.application'
ASGI_APPLICATION = 'barbershop_backend.asgi.application'
...
ALTERNATIVE_DBS = {
    "postgres": {
        ...
        'OPTIONS': {
            'sslmode': 'require',  # Obligatorio en PythonAnywhere
        },
    },
